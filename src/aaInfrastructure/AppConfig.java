...
public abstract class AppConfig {
    //Paths Storage
    public static final String DATABASE = "jdbc:sqlite:storage\\aaDatabases\\antCiberDron.sqlite" ;
    public static final String DATAFILE = "storage\\aaDataFiles\\AA.csv";
    public static final String LOGFILE  = "storage\\aaLogs\\AppErrors.log";
    ...
    public static final URL URL_SPLASH  = AppConfig.class.getResource("/aaInfrastructure/Assets/Img/Splash.png");
